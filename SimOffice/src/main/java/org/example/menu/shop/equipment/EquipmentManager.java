...
public class EquipmentManager {
    ...
    private org.example.menu.shop.furniture.EquipmentItemAdder equipmentItemAdder;

    public EquipmentManager(EquipmentInventory equipmentInventory, PlayerStatsManager playerStatsManager) {
        this.equipmentInventory = equipmentInventory;
        this.equipmentItemAdder = new org.example.menu.shop.furniture.EquipmentItemAdder(playerStatsManager);
    }
