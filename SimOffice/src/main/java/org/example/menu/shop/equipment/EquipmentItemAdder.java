...
public class EquipmentItemAdder {
    private final PlayerStatsManager playerStatsManager;

    public EquipmentItemAdder(PlayerStatsManager playerStatsManager) {
        this.playerStatsManager = playerStatsManager;
    }

    public void addEquipmentItem(Inventory inventory, int slot, Material material, String name, String description, int stars, int balanceRequirement, int levelRequirement, int rebirthsRequirement, Player player) {
