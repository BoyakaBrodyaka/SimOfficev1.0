...
public class RebirthHandler {
    private final double BASE_REBIRTH_COST = 1000000; // Пример начальной стоимости для перерождения
    ...
    public RebirthHandler(PlayerStatsManager playerStatsManager, String playerName) {
